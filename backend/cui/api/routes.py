...
from cui.domain.events import EDIT, make_event
from cui.api.deps import (
    get_collect_service,
    get_event_service,
    get_event_store,
    get_grill_service,
...
from cui.domain.projections import verdict_precedent
...
from cui.services.lens_feed_service import LensFeedService
...
def get_confirmed_evidence(
    ...
    possibly-empty list.
    """
    from cui.domain.projections import confirmed_ground_evidence
...
def get_versions(
    ...
    from cui.domain.projections import snapshot_projection
